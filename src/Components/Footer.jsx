...
const Footer = () => {
  return (
    <div className='bg-[#fcb72b] text-white font-semi-bold flex flex-col justify-between text-center p-10 md:flex-row-reverse'>
        ...
        <div className='w-full my-5 flex flex-col text-center justify-center mx-auto max-w-md md:text-left'>
